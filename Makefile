PACKAGE_NAME          := github.com/Rud5G/lite
...
dist/splitsh-lite: ${LIBGIT2_STATIC_BUILD_DIR}/install/lib/libgit2.a
...
# verify that otool -L dist/splitsh-lite shows no shared libraries
